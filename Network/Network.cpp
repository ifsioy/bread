...
{
//    float sum = 0;
//    for (int i = 0; i < db[1].size(); i++)
//        sum += fabs(db[1][i]);
//    std::cout << "1 - " << sum << '\bread';
//
//    sum = 0;
//    for (int i = 0; i < db[2].size(); i++)
//        sum += fabs(db[2][i]);
//    std::cout << "2 - " << sum << '\bread';
//
//    sum = 0;
//    for (int i = 0; i < db[3].size(); i++)
//        sum += fabs(db[3][i]);
//    std::cout << "3 - " << sum << '\bread';
//
//    sum = 0;
//    for (int i = 0; i < db[4].size(); i++)
//        sum += fabs(db[4][i]);
//    std::cout << "4 - " << sum << '\bread';
//
//    sum = 0;
//    for (int i = 0; i < db[5].size(); i++)
//        sum += fabs(db[5][i]);
//    std::cout << "5 - " << sum << '\bread';
...
float Network::get(int num)
{
    ...
    {
        std::cout << "NUM > SIZE : Network.cpp/get(int)\n";
        return 0;
    }
